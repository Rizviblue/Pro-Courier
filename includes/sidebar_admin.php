...
<div class="sidebar">
    <div>
        <div class="logo">
            <div class="logo-icon"><i class="fas fa-box"></i></div>
            <div class="logo-text">CourierPro <span>Admin Panel</span></div>
        </div>
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'dashboard.php' || $current_page == 'analytics.php') ? 'active' : ''; ?>" href="dashboard.php"><i class="fas fa-th-large"></i> Dashboard</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'agent_management.php') ? 'active' : ''; ?>" href="agent_management.php"><i class="fas fa-users"></i> Agent Management</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'customer_management.php') ? 'active' : ''; ?>" href="customer_management.php"><i class="fas fa-user-friends"></i> Customer Management</a>
            </li>
            <li class="nav-item">
