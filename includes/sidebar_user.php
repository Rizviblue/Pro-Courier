...
<div class="sidebar">
    <div>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'my_packages.php') ? 'active' : ''; ?>" href="my_packages.php"><i class="fas fa-box-open"></i> My Packages</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'support.php') ? 'active' : ''; ?>" href="support.php"><i class="fas fa-headset"></i> Support</a>
            </li>
            <li class="nav-item">
